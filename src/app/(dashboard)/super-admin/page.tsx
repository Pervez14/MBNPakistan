...
export default function SuperAdminPage() {
  ...
  const updateApplicationStatus = async (id: string, status: string) => {
    try {
      ...
      setErrorMessage(
        err instanceof Error ? err.message : 'Application could not be updated.'
      );
    } finally {
      setActionLoading('');
    }
    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-5">
        ...
        <StatCard
          ...
          subtitle="From public contact form"
        ...
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
          <div className="bg-white border border-slate-200 rounded-2xl p-6">
            ...
            <div className="mt-6 space-y-4">
              <Row label="Pending" value={stats.pendingApplications} />
              <Row label="Approved" value={stats.approvedApplications} />
              <Row label="Rejected" value={stats.rejectedApplications} />
            </div>
          </div>
      ...
      {activeTab === 'profiles' && (
        <div className="bg-white border border-slate-200 rounded-2xl overflow-hidden">
          <SectionHeader title="All Marriage Profiles" count={filteredProfiles.length} />
      ...
      {activeTab === 'logs' && (
        <div className="bg-white border border-slate-200 rounded-2xl overflow-hidden">
          <SectionHeader title="Contact View Logs" count={filteredLogs.length} />
