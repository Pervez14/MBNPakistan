...
export default function EditProfilePage() {
  ...
  const loadProfile = async () => {
    try {
      ...
      if (userError || !user) {
        throw new Error('Please login again to edit this profile.');
      }
      ...
      setFormData({
        ...
        photoVisibility: data.photo_visibility || 'public',
        ...
        expectedPartnerAge: data.expected_partner_age || '',
        expectedPartnerLocation: data.expected_partner_location || '',
        expectedPartnerEducation: data.expected_partner_education || '',
            ...
            <div>
              ...
              <div className="mt-5">
                ...
                <div className="mt-3 flex items-start gap-2 rounded-xl bg-amber-50 border border-amber-200 p-3 text-xs text-amber-800">
                  ...
                  <p>
                    Public is default. Use blurred or hidden only when the
              ...
              <div className="mt-5">
                ...
                <select
                  ...
                  className="input-field"
                >
                  <option value="active">Active - show in search</option>
                  <option value="inactive">Inactive - hide from search</option>
                </select>
              </div>
            </div>
          </div>
